...
<title>Telas Luz Maria - Cosplay</title>
<body>
		...
		<div id="inner">
			<div class="imgbg shadowDark">
				<div class="imgtagContainer">
					<div class="imgtag shadowDark textShadow"><h2>Cosplay</h2></div>
				</div>
				<table>
					<?php 
						$i=1;
						...
						while($i<67){
							echo ($flagHidden ? "<tr class=\"hiddenRow\" style=\"display:none;\">": "<tr>");
								for($j=0;$j<5;$j++){
									echo "<td>";
										$image = "images/cosplay/mini/$i.jpg";
										if(file_exists($image)){
											echo "<a href=\"#\"><img src=\"$image\" border =\"0\" height=\"185\" width=\"170\" alt=\"cosplay$i\"></a></td>";
										}
										$i++;
									echo "</td>";
									if($i==15){ $flag=true;	}
